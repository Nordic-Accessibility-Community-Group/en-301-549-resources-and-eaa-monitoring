...
4. In the description, name the country, show the result of each baseline check from `README.md`, and list any additional country-specific questions. List official sources, access dates, verified changes, unknown or disputed claims, and check results. Request human review of legal scope and translations.
